How to restrict a Junior Developer to work only on a feature branch in Git, especially if you're using a Git hosting service like GitHub, GitLab, or Bitbucket. 
