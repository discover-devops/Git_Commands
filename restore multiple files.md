You can restore multiple files in a single `git restore` command by specifying the files you want to restore or by using patterns. Here are several ways to do this:
